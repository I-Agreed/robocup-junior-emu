...
class Vision:
    def __init__(
        ...
        #TODO: ^- Change these to actual color of competition ball, not a tennis ball (also use the webcam camera)
        camHeight: int = 150,
        vidSource: int = 0,
    ):
        ...
        self.yellowGoalRange = (np.array(yellowGoalRange[0]), np.array(yellowGoalRange[1]))
